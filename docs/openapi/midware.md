...
-   :simple-elasticsearch:{ .lg .middle } __Elasticsearch OpenAPI__
    ...
    - [v0.13.0](mcamel/elasticsearch/elasticsearch-v0.13.0.md)
...
-   :simple-apachekafka:{ .lg .middle } __Kafka OpenAPI__
    ...
    - [v0.11.x](mcamel/kafka/kafka-v0.11.0.md)
...
-   :material-database:{ .lg .middle } __MinIO OpenAPI__
    ...
    - [v0.11.0](mcamel/minio/minio-v0.11.0.md)
...
-   :simple-mysql:{ .lg .middle } __MySQL OpenAPI__
    ...
    - [v0.14.0](mcamel/mysql/mysql-v0.14.0.md)

-   :simple-postgresql:{ .lg .middle } __PostgreSQL OpenAPI__

    ---

    - [v0.1.x](mcamel/postgresql/postgresql-v0.1.0.md), [v0.2.0](mcamel/postgresql/postgresql-v0.2.0.md)
    - [v0.3.0](mcamel/postgresql/postgresql-v0.3.0.md), [v0.4.0](mcamel/postgresql/postgresql-v0.4.0.md)
    - [v0.5.x](mcamel/postgresql/postgresql-v0.5.0.md), [v0.6.0](mcamel/postgresql/postgresql-v0.6.0.md)
    - [v0.7.0](mcamel/postgresql/postgresql-v0.7.0.md), [v0.8.0](mcamel/postgresql/postgresql-v0.8.0.md)
...
-   :simple-rabbitmq:{ .lg .middle } __RabbitMQ OpenAPI__
    ...
    - [v0.16.0](mcamel/rabbitmq/rabbitmq-v0.16.0.md)
...
-   :simple-redis:{ .lg .middle } __Redis OpenAPI__
    ...
    - [v0.14.0](mcamel/redis/redis-v0.14.0.md)
