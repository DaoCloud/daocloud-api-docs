...
-   :simple-elasticsearch:{ .lg .middle } __Elasticsearch OpenAPI__
    ...
    - [v0.11.0](mcamel/elasticsearch/elasticsearch-v0.11.0.md)
    - [v0.12.0](mcamel/elasticsearch/elasticsearch-v0.12.0.md)
...
-   :simple-apachekafka:{ .lg .middle } __Kafka OpenAPI__
    ...
    - [v0.9.0](mcamel/kafka/kafka-v0.9.0.md)
    - [v0.10.0](mcamel/kafka/kafka-v0.10.0.md)
...
-   :material-database:{ .lg .middle } __MinIO OpenAPI__
    ...
    - [v0.9.0](mcamel/minio/minio-v0.9.0.md)
    - [v0.10.0](mcamel/minio/minio-v0.10.0.md)
...
-   :simple-mongodb:{ .lg .middle } __MongoDB OpenAPI__
    ...
    - [v0.4.0](mcamel/mongodb/mongodb-v0.4.0.md)
    - [v0.5.0](mcamel/mongodb/mongodb-v0.5.0.md)
...
-   :simple-mysql:{ .lg .middle } __MySQL OpenAPI__
    ...
    - [v0.12.0](mcamel/mysql/mysql-v0.12.0.md)
    - [v0.13.0](mcamel/mysql/mysql-v0.13.0.md)
...
-   :simple-postgresql:{ .lg .middle } __PostgreSQL OpenAPI__
    ...
    - [v0.6.0](mcamel/postgresql/postgresql-v0.6.0.md)
    - [v0.7.0](mcamel/postgresql/postgresql-v0.7.0.md)
...
-   :simple-rabbitmq:{ .lg .middle } __RabbitMQ OpenAPI__
    ...
    - [v0.14.0](mcamel/rabbitmq/rabbitmq-v0.14.0.md)
    - [v0.15.0](mcamel/rabbitmq/rabbitmq-v0.15.0.md)
...
-   :simple-redis:{ .lg .middle } __Redis OpenAPI__
    ...
    - [v0.13.0](mcamel/redis/redis-v0.13.0.md)

-   :simple-apacherocketmq:{ .lg .middle } RocketMQ OpenAPI__
